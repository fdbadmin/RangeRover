...
function plotTornado(bars, unit, fullWidth) {
  ...
  if (gd) {
    ...
    // 3+ reservoirs: expand to the full panel width (align with the plots above)
    gd.style.maxWidth = fullWidth ? '100%' : '';
...
function runMultiReservoirSimulation() {
  ...
  if (perReservoir.length > 1) {
    ...
    plotTornado(bars, totalUnit, perReservoir.length >= 3);
  } else {
